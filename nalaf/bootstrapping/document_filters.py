...
class HighRecallRegexDocumentFilter(DocumentFilter):
    ...
    """
    def __init__(self, binary_model="nalaf/data/default_model", override_cache=False, expected_max_results=10, pattern_file_name=None, crfsuite_path=None):
        self.location_binary_model = binary_model
        """ location where binary model for nalaf (crfsuite) is saved """
        ...
        if not pattern_file_name:
            pattern_file_name = pkg_resources.resource_filename('nalaf.data', 'dict_nl_words.json')
