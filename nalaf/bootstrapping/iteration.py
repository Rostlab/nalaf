...
import re
import shutil
from nalaf.bootstrapping.document_filters import KeywordsDocumentFilter, HighRecallRegexDocumentFilter, ManualDocumentFilter
from nalaf.bootstrapping.pmid_filters import AlreadyConsideredPMIDFilter
...
from nalaf.preprocessing.definers import ExclusiveNLDefiner
import pkg_resources
from nalaf.learning.taggers import CRFSuiteMutationTagger
from nalaf.utils import MUT_CLASS_ID, THRESHOLD_VALUE
...
class Iteration():
    ...
    def docselection(self, nr=2):
        ...
        with DocumentSelectorPipeline(
                pmid_filters=[AlreadyConsideredPMIDFilter(self.bootstrapping_folder, self.number)],
                                      document_filters=[KeywordsDocumentFilter(), ManualDocumentFilter()]) as dsp:
