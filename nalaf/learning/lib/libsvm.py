...
class LIBSVM(RelationExtractor):
    """
    Base class to interact with [LIBSVM](https://www.csie.ntu.edu.tw/%7Ecjlin/libsvm/)
    """
    # Likely we want to create a hierarchy for ML "Trainers" or similar

    def __init__(self, model_path=None, classification_threshold=0.0, c=0, ):
