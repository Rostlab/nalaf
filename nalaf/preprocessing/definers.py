...
class ExclusiveNLDefiner(NLDefiner):
    ...
    def __init__(self):
        self.max_words = 4
        self.conventions_file = pkg_resources.resource_filename('nalaf.data', 'regex_st.json')
        self.tmvarregex_file = pkg_resources.resource_filename('nalaf.data', 'RegEx.NL')
        self.dict_nl_words_file = pkg_resources.resource_filename('nalaf.data', 'dict_nl_words.json')
...
class TmVarRegexNLDefiner(NLDefiner):
    ...
    def define(self, dataset):
        with open(pkg_resources.resource_filename('nalaf.data', 'RegEx.NL')) as file:
